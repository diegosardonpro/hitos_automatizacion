...
CHECK_INTERVAL = 300  # Segundos entre cada revisión (5 minutos)
...
def main():
    """
    Ciclo principal que revisa y procesa archivos periódicamente.
    """
    print("--- Iniciando Servicio de Vigilancia de Hitos ---")
    sheets_client = GoogleSheetsClient() # Inicializar el cliente una sola vez

    while True:
        print(f"\nBuscando archivos de Hitos (.md) en: {INPUT_DIR}")
        try:
        ...
        print(f"\nPróxima revisión en {CHECK_INTERVAL} segundos...")
